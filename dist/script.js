...
/* harmony import */ var _modules_moreStylesDB__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/moreStylesDB */ "./src/js/modules/moreStylesDB.js");
...
/* harmony import */ var _modules_accourdeon__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/accourdeon */ "./src/js/modules/accourdeon.js");
/* harmony import */ var _modules_accourdeonJS__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/accourdeonJS */ "./src/js/modules/accourdeonJS.js");
...
/* harmony import */ var _modules_scrollingUp__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/scrollingUp */ "./src/js/modules/scrollingUp.js");
/* harmony import */ var _modules_linksScroll__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/linksScroll */ "./src/js/modules/linksScroll.js");
/* harmony import */ var _modules_drugNdrop__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/drugNdrop */ "./src/js/modules/drugNdrop.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_accourdeonJS__WEBPACK_IMPORTED_MODULE_10__["default"])('.accordion-heading');
  Object(_modules_burger__WEBPACK_IMPORTED_MODULE_11__["default"])('.burger-menu', '.burger');
  Object(_modules_scrollingUp__WEBPACK_IMPORTED_MODULE_12__["default"])('.pageup');
  Object(_modules_linksScroll__WEBPACK_IMPORTED_MODULE_13__["default"])();
  Object(_modules_drugNdrop__WEBPACK_IMPORTED_MODULE_14__["default"])();
});

/***/ }),

/***/ "./src/js/modules/accourdeon.js":
/*!**************************************!*\
  !*** ./src/js/modules/accourdeon.js ***!
  \**************************************/
...
var accourdeon = function accourdeon(triggerSelector, itemSelector) {
...
/* harmony default export */ __webpack_exports__["default"] = (accourdeon);
    ...
    link.addEventListener('click', function (event) {
      ...
      function step(time) {
        ...
        var progress = time - start,
            px = topOfBlock < 0 ? Math.max(widthTop - progress / speed, widthTop + topOfBlock) : Math.min(widthTop + progress / speed, widthTop + topOfBlock);
...
/* harmony default export */ __webpack_exports__["default"] = (linksScroll);
...
/***/ "./src/js/modules/moreStylesDB.js":
/*!****************************************!*\
  !*** ./src/js/modules/moreStylesDB.js ***!
  \****************************************/
/*! exports provided: default */
...
var moreStylesDB = function moreStylesDB(trigger, wrapper) {
  ...
  function createCards(response) {
    response.forEach(function (_ref) {
      ...
      document.querySelector(".card-block").classList.add("animated", "slideInDown");
      document.querySelector(wrapper).appendChild(card);
    });
  }
};

/* harmony default export */ __webpack_exports__["default"] = (moreStylesDB);

/***/ }),

/***/ "./src/js/modules/pictureSizing.js":
/*!*****************************************!*\
  !*** ./src/js/modules/pictureSizing.js ***!
  \*****************************************/
/*! exports provided: default */
...
var pictureSizing = function pictureSizing(imgSelector) {
...
/* harmony default export */ __webpack_exports__["default"] = (pictureSizing);

/***/ }),

/***/ "./src/js/modules/scrollingUp.js":
/*!***************************************!*\
  !*** ./src/js/modules/scrollingUp.js ***!
  \***************************************/
/*! exports provided: default */
...
var scrollingUp = function scrollingUp(arrowSelector) {
  var upElem = document.querySelector(arrowSelector);
  window.addEventListener('scroll', function () {
  ...
  var countScroll = function countScroll() {
    upElem.addEventListener('click', function (event) {
      var scrollToTop = Math.round(body.scrollTop || element.scrollTop);
  ...
  var smoothScroll = function smoothScroll(from, to, hash) {
    ...
    var move = setInterval(function () {
      ...
      if (prevScrollToTop === scrollToTop || to > from && scrollToTop >= to || to < from && scrollToTop <= to) {
        clearInterval(move);
...
/* harmony default export */ __webpack_exports__["default"] = (scrollingUp);
...
var sliders = function sliders(slides, direction, prev, next) {
  ...
  function activateSlideAnimation(params) {
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Невозможно получить данные из ${url}, status: ${res.status}");
